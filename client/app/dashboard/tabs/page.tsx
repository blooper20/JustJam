              ...
              <Card
                className={cn(
                  ...
                  project.status === 'completed'
                    ? 'hover:shadow-lg hover:-translate-y-1 hover:border-pink-500/50'
                    : 'grayscale border-zinc-900',
                )}
              >
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Activity
                      className={cn(
                        'h-4 w-4',
                        project.status === 'completed' ? 'text-pink-500' : 'text-zinc-600',
                      )}
                    />
                  </div>
                </CardHeader>
